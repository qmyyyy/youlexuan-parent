							...
							<#list specificationList as specification>
                                <dl>
									...
									<#list specification.attributeValue as item>
										<dd><a class="{{isSelected('${specification.attributeName}','${item}')?'selected':''}}" ng-click="selectSpecification('${specification.attributeName}','${item}')" href="javascript:;" >${item}</a></dd>
									</#list>
                                </dl>
							</#list>
                    ...
                    <div class="summary-wrap">
                        <div class="fl title">
                            <div class="control-group">
                                <div class="controls">
                                    <input value="{{num}}" autocomplete="off" type="text" value="1" minnum="1" class="itxt" />
